...
root.iconbitmap('data/graphics/logo.ico')

limite = 7

# Les images
images = [PhotoImage(file="data/graphics/pendu_"+str(nb_echecs)+".png") for nb_echecs in range(limite + 1)]

fail = PhotoImage(file="data/graphics/wasted.png")
win = PhotoImage(file="data/graphics/win.png")
